...
ALTER SEQUENCE public.blackhole_blackhode_id_seq OWNED BY public.blackhole.blackhole_id;
...
ALTER TABLE ONLY public.blackhole ALTER COLUMN blackhole_id SET DEFAULT nextval('public.blackhole_blackhode_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.blackhole_blackhode_id_seq', 3, true);
