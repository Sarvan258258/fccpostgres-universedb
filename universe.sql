...
--
-- Name: blackhole_blackhode_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.blackhole_blackhode_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.blackhole_blackhode_id_seq OWNER TO freecodecamp;

--
-- Name: blackhole_blackhode_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.blackhole_blackhode_id_seq OWNED BY public.blackhole.blackhode_id;
...
--
-- Name: blackhole blackhode_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.blackhole ALTER COLUMN blackhode_id SET DEFAULT nextval('public.blackhole_blackhode_id_seq'::regclass);
...
INSERT INTO public.galaxy VALUES (1, NULL, NULL, 'galaxy1', 10000);
...
INSERT INTO public.planet VALUES (10, 'yuho', NULL, false, 1);
INSERT INTO public.planet VALUES (11, 'kaka', NULL, false, 2);
INSERT INTO public.planet VALUES (12, 'pika', NULL, false, 2);
...
INSERT INTO public.star VALUES (1, 1234, 'green', 'star1', 1);
INSERT INTO public.star VALUES (2, 12234, 'yellow green', 'star2', 1);
INSERT INTO public.star VALUES (3, 7234, 'yellow', 'star3', 1);
INSERT INTO public.star VALUES (4, 7245, 'red', 'star4', 1);
INSERT INTO public.star VALUES (5, 7945, 'black', 'star5', 1);
INSERT INTO public.star VALUES (6, 8945, 'white', 'star6', 2);


--
-- Name: blackhole_blackhode_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.blackhole_blackhode_id_seq', 1, false);
...
ALTER TABLE ONLY public.blackhole
    ADD CONSTRAINT blackhole_pkey PRIMARY KEY (blackhode_id);
